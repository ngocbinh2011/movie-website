                    ...
                    <div class="col-md-12">
                        <div class="card p-3 shadow">
                            ...
                            >
                                ...
                                <tbody>
                                <c:forEach items="${listActorOfMovie}" var="actor" varStatus="status">
                                    <tr>
                                        <td class="col-4">${status.index + 1}</td>
                                        <td class="col-4">${actor.id}</td>
                                        <td class="col-4">${actor.name}</td>
                                        <td class="col-4">${actor.code}</td>
                                        <td>
                                            <a href="delete/${actor.id}/"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                </c:forEach>
