                ...
                <div class="col-md-12">
                    <div class="card p-3 shadow">
                        ...
                        >
                            ...
                            <tbody>
                            <c:forEach items="${listKey}" var="tag" varStatus="status">
                                <tr>
                                    <td class="col-4">${status.index + 1}</td>
                                    <td class="col-4">${tag.id}</td>
                                    <td class="col-4">${tag.name}</td>
                                    <td class="col-4">${tag.code}</td>
                                    <td>
                                        <a href="delete/${tag.id}/"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                            </c:forEach>
