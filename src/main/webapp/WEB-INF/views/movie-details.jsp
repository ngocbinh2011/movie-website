...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/reset-movie-details.css"/>">
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/style-movie-details.css"/>">
    <!-- font awesome  -->
...
<div id="content">
    <div class="singlecontent minwidth">
        <div class="breadcrumb">
            ...
            <span class="breadcrumb-link-wrap">
<%--                    <c:set var="content" value="${series}"></c:set>--%>
<%--                    <c:if test="${movie.amountEpisode == 1}">--%>
<%--                        <c:set var="content" value="${feature}"></c:set>--%>
<%--                    </c:if>--%>
                    <a class="breadcrumb-link" href="/the-loai/phim-le">
            ...
            <div class="infodb">
                <div class="infl">
                    <div class="left">
                        ...
                        <div class="button-play"><a class="btn-play" href="/xem-phim/${movie.code}" title="${movie.name}"><i class="fa fa-play"></i> Xem Phim</a>
                        </div>
                    ...
                    <div class="latest entry-content">
                        <div class="more">
                            <h2 class="title-nav"><span>Nội Dung Phim ${movie.name}</span></h2>
                            <div class="clear"></div>
                        </div>
                        <div class="item-content">
                            <p>${movie.mainContent}</p>
                            <p style="text-align:center">
                                <img alt="" src="${movie.imageLinkMain}" />
                            </p>
                        </div>
                    </div>
                    <div id="tags">
...
<script src="<c:url value="/resources/js/movieDetails.js"/>"></script>
